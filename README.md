...
## Forked from PrawnoS (FIXME, link), which is a build system for making blobless Debian and mainline Linux kernel with support for libre ath9k wireless, dmcrypt/LUKS root partition encryption, and graphics acceleration using panfrost
...
* Support for onboard Broadcom (FIXME chipset) WiFi.
